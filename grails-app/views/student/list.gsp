			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="passwordExpired" title="${message(code: 'student.passwordExpired.label', default: 'Password Expired')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${studentInstance.passwordExpired}" /></td>
